...
We would like to leverage the skills learned in p8105 and the data visualization capabilities in R to explore this clinical question. -->
...
1) An interactive dashboard using plotly to present univariate and multivariate regression models assessing the association of demographic factors and past medical history with the need for hospital admission among pediatric patients.
